...
template<typename I, typename T>class GS    {public:static void Get(I* pit, T& t, int offs){static_assert("Type is not supported");}};
...
template<typename I, typename T>class PS{public:static void Put(I* pit, T& t, int offs){static_assert("Type is not supported");}};
