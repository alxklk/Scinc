...
extern "C" int fopen_wrapper(ScincVM* s, void*){ScincBoundCall(s,fopen_impl);return 0;}

int fclose_impl(FILE_ptr f){return fclose(f.f);}
extern "C" int fclose_wrapper(ScincVM* s, void*){ScincBoundCall(s,fclose_impl);return 0;}

int fwrite_impl(char* ptr, int size, int n, FILE_ptr f){return fwrite((void*)ptr, size, n, f.f);};
extern "C" int fwrite_wrapper(ScincVM* s, void*){ScincBoundCall(s,fwrite_impl);return 0;}
