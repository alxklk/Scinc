...
float fx(float x)
{
	return (cos(x*13+T)*200*sin(T*1.1)+cos(x*27.5-T*2.3)*150*sin(T*.9)+sin(x*3.1)*150*sin(T*.7))*.25;
}

float fy(float x)
{
	return (sin(x*13+T)*200*sin(T*1.1)+sin(x*27.5-T*.3)*150*sin(T*.9)+cos(x*3.1)*150*sin(T*.7))*.25;
}
